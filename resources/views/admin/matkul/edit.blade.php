            ...
            <form action="{{ route('matkul.update',$matkul->id) }}" method="post">
              @method('put')
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control @error('kode_matkul') is-invalid @enderror" id="kode_matkul" name="kode_matkul" value="{{old('kode_matkul',$matkul->kode_matkul)}}">
                      @error('kode_matkul')
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control @error('nama_matkul') is-invalid @enderror" id="nama_matkul" name="nama_matkul" value="{{old('nama_matkul',$matkul->nama_matkul)}}">
                        @error('nama_matkul')
                ...
                <div class="form-group row">
                  ...
                  <select class="form-select" name="jenjang_id">
                    ...
                    @if (old('masterKurikulum_id',$matkul->jenjang_id)==$item->id)
