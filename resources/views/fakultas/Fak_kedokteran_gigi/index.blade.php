              ...
              <div class="row">
                <div class="col-sm-12">
                  <div class="card-box table-responsive">
                      <a  href="{{route('metode.create')}}" type="button" class="btn btn-primary">Tambah Data</a>
                      <button type="button" class="btn btn-success">Upload Data Excel</button>
            <table id="datatable-buttons" class="table table-striped table-bordered" style="width:100%">
              <thead>
                <tr>
                  <th rowspan="2" class="align-middle">Program Studi</th>
                  <th rowspan="2" class="align-middle">nama matakuliah</th>
                  <th colspan="3" class="text-center">Metode Pemebelajaran</th>
              ...
              <tbody>
                ...
                {{-- @dd( $metode->matkul->prodi->faculty->nama_fakultas ); --}}
                <tr>
                  <td>{{ $metode->matkul->prodi->nama_prodi }}</td>
                  <td>{{$metode->matkul->nama_matkul}}</td>
                  <td class="text-center">
                     <input class="form-check-input" type="checkbox" value="false" id="flexCheckDefault"  {{ ($metode->project_base_learning==1)?"checked":"" }}>
                  </td>
                  <td class="text-center">
                    <input class="form-check-input" type="checkbox" value="true" id="flexCheckChecked" {{ ($metode->case_base_learning==1)?"checked":"" }} >
                  </td>
                  <td class="text-center">
                    <input class="form-check-input" type="checkbox" value="false" id="flexCheckChecked" {{ ($metode->collaborative_learning ==1)?"checked":"" }}>
                  </td>
